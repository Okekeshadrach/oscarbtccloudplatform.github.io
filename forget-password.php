...
<!-- Document Title
    ============================================= -->
<title>FORGOTTEN PASSWORD  | Oscar Bitcoin cloud platform </title>
</head>
<body>
<div class="preloader">
...
<div class="collapse navbar-collapse pull-right" id="navbar-collapse-1">
	<ul class="nav navbar-nav navbar-left nav-pos-right">
		...
		<li>
			<a href="about-us.php" class="dropdown-toggle menu-item">NEWS</a>
		</li>
		<li>
		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="heading heading-2 mb-50">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<h2 class="heading--title text-white" style="font-weight:bold;"><span class="text-theme">FORGOTTEN</span><span class="text-white"> PASSWORD</span></h2>
						</div>
					</div><!-- .row end -->
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							...
							<form class="mb-0" method="POST">
                                ...
                                if(isset($_POST['send_mail'])){
                                    $mail = trim($_POST['email1']);
                                    if($class->Mailme_restpassworlink($mail)){
                ...
                // echo '<a class="btn btn-warning d-none d-sm-block" style="font-size:15px;color:#fff;"><b>Email not found! </b> try again</a><br />';
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
        <input type="email" name="email1" required class="form-control" placeholder="YOUR REGISTERED EMAIL" style="padding:30px;color:#001656;font-weight:bold;">
                            </div>

                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <input type="submit" name="send_mail" value="Retrive Password" class="btn btn--primary btn--block">
							</div>
							<div class="col-xs-12 col-sm-12 col-md-12">
                       <br /><br />
                   </div>
