		...
		<div class="row">
			...
			<div class="col-xs-12">
	            ...
	            <div class="container text-center" style="background-color:#dcffc3;">
	                ...
	                <br /><br />
	                <h1 class="" style="font-weight:bold;color:#469913;">SUCCESS!</h1>
	            </div>
	            <!-- header ends here -->

	            <!-- body -->
	            <div class="container text-center" style="background-color:#efefef;padding-top:50px;padding-right:50px;">
	                        <p style="color:#464d58;font-size:16px;height:300px;">
                         Your password has been changed! Thanks you!
                           <br />
				...
				<div class="heading heading-2 mb-50">
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							...
							<p class="heading--desc">oscarbitcoincloudplatform serves large scale investors from Northern Europe <br />and North America.oscarbitcoincloudplatform, offers the opportunity to small scale investors to take part in the trading on the world financial markets and earn significant profits.<br /><br /><br />
							</p>
						</div>
