...
<link href="assets/images/favicon/main_icon.png" rel="icon">
...
<!-- Document Title
    ============================================= -->
<title>PASSWORD SET | Oscar Bitcoin cloud platform </title>
</head>
<body>
<div class="preloader">
...
<section id="consultation" class="consultation consultation-1 pb-0">
	...
	<div class="container">
		<div class="row">
			...
			<section>
	            <!-- header -->
	            <div class="container text-center" style="background-color:#dcffc3;">
	                <!-- <img src="assets/images/logo/pa.png" alt="SUCCESSFUL" width="20%" /> -->
	                 <!--<img src="assets/images/background/mail_sent.png" width="20%" alt="mail sent" />--><br /><br />
                        <h1 class="" style="font-weight:bold;color:#469913;">FORGOTTEN PASSWORD</h1>
	            </div>
	            <!-- header ends here -->

	            <!-- body -->
	            <div class="container text-center" style="background-color:#efefef;padding-top:50px;padding-right:50px;">
	                     <p style="color:#717070;font-size:16px;">
                           An email has been sent to the email address.
                           <br />
                            please follow the instruction to set a new password. 
                            The email may take up to 1 minute to be delivered, please be patient. 
				...
				<div class="heading heading-2 mb-50">
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							...
							<p class="heading--desc">oscar-bitcoin-cloud-platform serves large scale investors from Northern Europe <br />and North America.oscarbitcoincloudplatform, offers the opportunity to small scale investors to take part in the trading on the world financial markets and earn significant profits.<br /><br /><br />
							</p>
						</div>
			...
			<div class="row clearfix">
				<div class="col-xs-12 col-sm-4 col-md-3 footer--widget widget-about">
					<div class="widget-content">
						...
						<p>oscarbitcoincloudplatform offers investors 3 investment plans for a minimum investment of $100 USD. The plans consist of 2 daily paying plans and 4 expiry plans.</p>
						<div class="copyright">
							<a target="_blank" href="https://templateshub.net">oscarbitcoincloudplatform.net</a>
						</div>
					</div>
				</div><!-- .col-md-3 end -->
