				...
				<div class="heading heading-2 mb-50">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<h2 class="heading--title text-white" style="font-weight:bold;"><span class="text-theme">LOG</span><span class="text-white"> IN</span></h2>
						</div>
					</div><!-- .row end -->
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            $username = trim($_POST['f1']);
                            $password = trim($_POST['f2']);

                            if(empty($username) || empty($password)){
                    echo '  <div style="padding:19px; background-color:#ffdfaa;color:#c68317;" class="sr_flash">
                                <b>Username of password is empty!</b> fill in the space and try again</a>
                            </div><br /><br />';
                            }else if($class->login_user($username,$password,$last_seen)){
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
    <input type="text" name="f1" class="form-control" placeholder="USERNAME" style="padding:30px;color:#001656;font-weight:bold;" required>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
    <input type="password" name="f2" class="form-control" placeholder="PASSWORD" style="padding:30px;color:#001656;font-weight:bold;" required>
                            </div>

                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <input type="submit" name="login_user" value="LOGIN" class="btn btn--primary btn--block"><br /><br />
							</div>

							<div class="col-xs-12 col-sm-12 col-md-6">
                                <a href="signup.php" class="btn btn-info btn--block">CREATE ACCOUNT</a>
							</div>
                       ...
                       <br /><br />
							...
							<div class="col-xs-12 col-sm-12 col-md-12">
                         <b style="color:#ffffff;"> Forgotten your password? click to &nbsp; <a href="forget-password.php" target="_blank">Retrive password</a> </b>
                            </div>
