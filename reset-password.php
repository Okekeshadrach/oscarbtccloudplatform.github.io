...
<!-- Document Title
    ============================================= -->
<title>RESET PASSWORD | Oscar Bitcoin cloud platform </title>
</head>
<body>
<div class="preloader">
				...
				<div class="heading heading-2 mb-50">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<h2 class="heading--title text-white" style="font-weight:bold;"><span class="text-theme">RESET </span><span class="text-white"> PASSWORD</span></h2>
						</div>
					</div><!-- .row end -->
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							...
							<form class="mb-0" method="POST">
								 ...
								 <?php
                         // $password_ID = $_GET['passwordID'];
                         // echo $password_ID;
                            if(isset($_POST['reset_password'])){
                                // $password_ID = $_POST['passwordID'];
                                $set_pass1 = trim($_POST['password1']); 
                                $set_pass2 = trim($_POST['password2']);

                                 $password_ID = $_GET['passwordID'];

                                if($set_pass1==$set_pass2){
                                    $class->reset_password($set_pass1,$password_ID);
                                    echo '<script>window.location="password-set.php"</script>';
                                }else{
                                   echo ' <div style="padding:19px; background-color:#d61515;color:#fff;" class="sr_flash">
                            <b>Password not matched! </b> try again
                        </div><br /><br />';
                                 }
                            }
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
        <input type="password" name="password1" class="form-control" required placeholder="NEW PASSWORD" style="padding:30px;color:#187503;font-weight:bold;">
                            </div>

                            <div class="col-xs-12 col-sm-12 col-md-12">
    <input type="password" name="password2" class="form-control" required placeholder="RE-ENTER NEW PASSWORD" style="padding:30px;color:#187503;font-weight:bold;">
                            </div>
